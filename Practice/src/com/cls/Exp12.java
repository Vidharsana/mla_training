...
public class Exp12 {
	...
	public static void main(String args[]) {
		...
		data.add(new Book(401,"python","Sri",5));
		...
		data.parallelStream().filter(bk->bk.getPrice()>=10&&bk.getPrice()<=20).forEach(book->System.out.println(book.getId()+" "+book.getName()+" "+book.getAuthor()+" "+book.getPrice()));
	}
}
